...
/mob/dead/new_player/proc/get_title_html()
	...
	if(SSticker.current_state == GAME_STATE_STARTUP)
		...
		if(!SSticker || SSticker.current_state <= GAME_STATE_PREGAME)
			...
			dat += {"
				<a class="menu_button" href='?src=[text_ref(src)];late_join=1'>加入游戏</a>
				<a class="menu_button" href='?src=[text_ref(src)];view_manifest=1'>船员列表</a>
				<a class="menu_button" href='?src=[text_ref(src)];view_directory=1'>角色列表</a>
			"}

		dat += {"<a class="menu_button" href='?src=[text_ref(src)];observe=1'>观察</a>"}

		dat += {"
			<hr>
			<a class="menu_button" href='?src=[text_ref(src)];character_setup=1'>角色设置(<span id="character_slot">[uppertext(client.prefs.read_preference(/datum/preference/name/real_name))]</span>)</a>
			<a class="menu_button" href='?src=[text_ref(src)];game_options=1'>游戏设置</a>
			<a id="be_antag" class="menu_button" href='?src=[text_ref(src)];toggle_antag=1'>[client.prefs.read_preference(/datum/preference/toggle/be_antag) ? "<span class='checked'>☑</span> 当反派" : "<span class='unchecked'>☒</span> 当反派"]</a>
			<hr>
			<a class="menu_button" href='?src=[text_ref(src)];server_swap=1'>切换服务器</a>
		"}
		...
		<script language="JavaScript">
			...
			var antag_marks = \[ "<span class='unchecked'>☒</span> 当反派", "<span class='checked'>☑</span> 当反派" \];
